...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是一个父亲,爱学习的人',
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://geoivf.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '生活,学习,快乐 ', // 网站关键词 英文逗号隔开
